...
@php
    ...
    $user = auth()->user();
    $isVendorUser = $user->hasAnyRole(['vendor', 'vendoruser']);
    $userrole = $user->getRoleNames();

    $admnrole = $user->hasRole('admin');
                        ...
                        <a href="javascript:void(0);">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect fill="var(--bs-heading-color)" x="4" y="11" width="16" height="2"
                                        rx="1" />
                                    <rect fill="var(--bs-heading-color)" opacity="1.0"
                    ...
                    {{-- <div class="card-body contacts_body p-0 ic-scroll  " id="ic_W_Contacts_Body">
                        <ul class="contacts">
                            ...
                            <li class="ic-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ url('assets/images/avatar/small/avatar3.webp') }}"
                                            class="rounded-circle user_img" alt="">
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="ic-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ url('assets/images/avatar/small/avatar4.webp') }}"
                                            class="rounded-circle user_img" alt="">
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="ic-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ url('assets/images/avatar/small/avatar5.webp') }}"
                                            class="rounded-circle user_img" alt="">
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="ic- -user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ url('assets/images/avatar/small/avatar6.webp') }}"
                                            class="rounded-circle user_img" alt="">
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="ic-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ url('assets/images/avatar/small/avatar7.webp') }}"
                                            class="rounded-circle user_img" alt="">
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="ic-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ url('assets/images/avatar/small/avatar8.webp') }}"
                                            class="rounded-circle user_img" alt="">
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="ic-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ url('assets/images/avatar/small/avatar9.webp') }}"
                                            class="rounded-circle user_img" alt="">
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="ic-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ url('assets/images/avatar/small/avatar10.webp') }}"
                                            class="rounded-circle user_img" alt="">
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <path
                                        ...
                                        fill="var(--bs-heading-color)" fill-rule="nonzero"
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="javascript:void(0);"><i
                                            class="fa fa-user-circle text-primary me-1"></i> View profile</a>
                                </li>
                                <li><a class="dropdown-item" href="javascript:void(0);"><i
                                            class="fa fa-users text-primary me-1"></i> Add to Friends</a></li>
                                <li><a class="dropdown-item" href="javascript:void(0);"><i
                                            class="fa fa-plus text-primary me-1"></i> Add to group</a></li>
                                <li><a class="dropdown-item" href="javascript:void(0);"><i
                                            class="fa fa-ban text-primary me-1"></i> Block</a></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                ...
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <path
                                        ...
                                        fill="var(--bs-heading-color)" fill-rule="nonzero" opacity="1" />
                                    <path
                        ...
                        <ul class="contacts">
                            <li class="active">
                                <div class="d-flex bd-highlight">
                                    ...
                                    <div class="ms-auto">
                                        <a href="javascript:void(0);"
                                            class="btn btn-square btn-xs btn-primary light ms-1"><i
                                                class="fas fa-pencil-alt"></i></a>
                                        <a href="javascript:void(0);"
                                            class="btn btn-square btn-xs btn-danger light"><i
            ...
            <div class="collapse navbar-collapse justify-content-between">
                <a href="index.html" class="brand-logo" aria-label="Brand Logo">
                    <svg class="logo-abbr" width="26" height="28" viewBox="0 0 26 28" fill="none"
                        ...
                        <path d="M11.7002 21.3959C11.7002 23.2237 11.7003 25.0515 11.6998 26.8792C11.6998 26.9941 11.7011 27.1096 11.69 27.2236C11.6319 27.8192 11.238 28.0037 10.7265 27.7033C8.84575 26.5987 6.95798 25.5061 5.07503 24.4052C3.78792 23.6527 2.49338 22.912 1.22394 22.1307C0.579454 21.734 0.312351 21.051 0.163525 20.3476C0.0628203 19.8717 0.0276414 19.3743 0.0253859 18.8863C0.0101364 15.5859 0.0103542 12.2855 0.00929385 8.985C0.00919286 8.66909 -0.0766978 8.30189 0.275725 8.11069C0.630101 7.91842 0.929739 8.12665 1.23296 8.30542C2.93186 9.3071 4.63512 10.3014 6.33822 11.296C7.31084 11.8639 8.29053 12.42 9.25834 12.996C9.80354 13.3204 10.3391 13.6626 10.8644 14.0184C11.4737 14.4311 11.6866 15.0552 11.6898 15.7559C11.6986 17.6359 11.6928 19.5159 11.6928 21.3959C11.6953 21.3959 11.6977 21.3959 11.7002 21.3959Z" fill="var(--nav-logo-primary)" />
                        <path d="M25.6234 14.1081C25.6234 15.8518 25.6489 17.5959 25.6156 19.339C25.5869 20.8431 24.8493 21.948 23.5512 22.6911C21.5313 23.8474 19.5128 25.0063 17.4936 26.1639C16.5156 26.7246 15.5389 27.2875 14.5586 27.8441C13.9628 28.1824 13.5041 27.9622 13.4197 27.2792C13.3803 26.961 13.4109 26.634 13.4119 26.311C13.4145 25.4651 13.4294 24.619 13.4182 23.7733C13.4078 22.9958 13.6852 22.4268 14.3983 22.033C16.0336 21.1302 17.6448 20.1835 19.2623 19.2487C19.4781 19.124 19.6826 18.9756 19.8769 18.8191C20.2235 18.54 20.3805 18.1727 20.3793 17.7227C20.3745 15.9264 20.3797 14.1301 20.3817 12.3338C20.3819 12.1354 20.3807 11.9368 20.3884 11.7386C20.4163 11.0208 20.6844 10.4784 21.3657 10.1224C22.4846 9.53765 23.5697 8.88831 24.6699 8.26757C24.7787 8.20614 24.8888 8.14344 25.0052 8.09943C25.3152 7.98221 25.6025 8.14336 25.664 8.46987C25.685 8.58149 25.6816 8.69855 25.6817 8.81313C25.6827 10.5781 25.6824 12.3431 25.6824 14.1081C25.6627 14.1081 25.643 14.1081 25.6234 14.1081Z"
                            fill="var(--nav-logo-primary)" />
                        <path opacity="0.25"
                ...
                <li class="nav-item dropdown" style="margin-left: 2rem">
                    <select name="vendor_id" @if($admnrole == false) disabled @else  @endif class="form-select" id="vendors_Select">
                        <option value="">Select Vendor</option>

                        @if($admnrole == false)
                           <option value="{{ $user?->vendor_id }}" disabled selected>{{ $user?->vendor?->name }}</option>
                        @else
                        ...
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"
                            ...
                            <div class="profile-head">
                                <div class="profile-media">
                                    <img src="{{ url('assets/images/user_icon.jpg') }}" alt="">
                                </div>
                            </div>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <div class="py-2 d-flex px-3">
                                    <img src="{{ Auth::user()->profile_photo_url ?? url('assets/images/user_icon.jpg') }}"
                                        class="avatar avatar-sm rounded-circle" alt="User Avatar">
                                    <div class="ms-2">
                            ...
                            {{-- <li>
                                <a class="dropdown-item" href="app-profile.html">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19"
                                        ...
                                        <path stroke="var(--bs-primary)" d="M21.21 15.89A10 10 0 1 1 8 2.83">
                                        </path>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            stroke="var(--bs-primary)" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <circle cx="12.175" cy="11.889" r="2.63616" stroke="var(--bs-primary)"
