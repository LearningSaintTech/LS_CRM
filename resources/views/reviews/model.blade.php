<div class="offcanvas offcanvas-end custom-offcanvas" tabindex="-1" id="offcanvasExample">
    <div class="offcanvas-body">
        <form action="{{ route('insert.reviews') }}" method="post" enctype="multipart/form-data"
            onSubmit="document.getElementById('submit').disabled=true;">
            @csrf
            <div class="offcanvas-header pb-0">
                <h2 class="modal-title fs-5" id="#gridSystemModal">Add Review</h2>
            ...
            <div class="row">
                <div class="col-xl-6 mb-3">
                    <input type="hidden" name="id" id="reviews_id">
