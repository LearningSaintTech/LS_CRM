                ...
                <div class="card">
                    ...
                    <div class="card-body px-2 pt-0 pb-2">
                        <div class="table-responsive check-wrapper">
                            <table
                                class="table table-sm table-row-rounded table-borderless table-sm-responsive text-nowrap mb-2">
                                <thead>
                                    <tr class="text-nowrap">
                                        <th class="sorting-disabled">
                                            <div class="form-check custom-checkbox ms-0 mb-0">
                                                <input type="checkbox" class="form-check-input check-all"
                                                    aria-label="Projects checkbox" required>
                                            </div>
                                        </th>
                                        <th>Customer</th>
                                        <th>Item</th>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check custom-checkbox">
                                                <input type="checkbox" class="form-check-input check-input"
                                                    aria-label="Projects checkbox" required checked>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1 justify-content-end">
                                                ...
                                                <div class="dropdown">
                                                    <button class="btn btn-square btn-sm btn-secondary tp-btn-light"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <a class="dropdown-item" href="javascript:void(0);">On
                                                            Hold</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="card-reviews">
                                            ...
                                            <p class="mb-0 text-gray-600">Absolutely love this product! Great quality,
                                                fast shipping, and excellent customer service. It exceeded my
                                                expectations in every way. I’ll definitely be a repeat customer. Highly
