...
Route::group(['prefix' => 'websites', 'middleware' => 'auth'], function () {
    ...
    Route::get('websites-list/{id}', [WebsiteController::class, 'websiteslist'])->name('websites.list');
    Route::get('websites-list', [WebsiteController::class, 'menuwebsiteslist'])->name('menu.websites.list');
    ...
    Route::get('website-delete', [WebsiteController::class, 'websitedelete'])->name('website.delete');
